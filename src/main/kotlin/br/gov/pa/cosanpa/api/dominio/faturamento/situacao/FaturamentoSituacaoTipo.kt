...
data class FaturamentoSituacaoTipo(
    ...
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "lalt_idleitafaturarcomleit", referencedColumnName = "lalt_id", insertable = false, updatable = false)
    val leituraAnormalidadeLeituraComLeitura: LeituraAnormalidadeLeitura,

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "lalt_idleitafaturarsemleit", referencedColumnName = "lalt_id", insertable = false, updatable = false)
