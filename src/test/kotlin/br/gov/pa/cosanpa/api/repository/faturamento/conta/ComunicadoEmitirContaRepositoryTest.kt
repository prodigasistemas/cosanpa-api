...
class ComunicadoEmitirContaRepositoryTest {

    @Autowired
    private lateinit var repo: ComunicadoEmitirContaRepository

    @Test
    fun `dado os parametros passados corretamente, retorna quantidade de comunicados`() {
        val resultado = repo.possuiComunicadoEmitido(2035375, 2, 1, 202202)
        assertEquals(1, resultado.toInt())
    }

    @Test
    fun `dado os parametros passados de imovel sem comunicados, retorna 0`() {
        val resultado = repo.possuiComunicadoEmitido(7389353, 1, 1, 202212)
